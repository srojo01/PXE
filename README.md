...
* Ir la MV1.
* Instalamos el servicio DHCP (`zypper in dhcp-server yast2-dhcp-server`) o ejecutamos el archivo **[dhcp-serverInstall.sh](https://github.com/srojo01/PXE/blob/main/src/dhcp-serverInstall.sh)** que hay en la carpeta **src** del github
